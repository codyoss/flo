...
func TestTypeOfStep(t *testing.T) {
	tests := []struct {
		...
		{"invalid fn 1 wrong out parm right in", func(ctx context.Context) int { return 0 }, invalid},
		{"invalid fn 1 wrong in parm right out", func(ctx context.Context) error { return nil }, invalid},
